    ...
    <div>
      ...
      <div className="grid gap-4 xl:grid-cols-[280px_1fr_290px]">
        ...
        <Card className="min-h-[760px] overflow-hidden p-0">
          <div className="flex items-center justify-between border-b border-white/10 bg-white/[.035] px-4 py-3">
            ...
            <div className="flex gap-2 text-xs font-bold text-white/45"><span>Desktop</span><span>•</span><span>{sections.length} sections</span></div>
          </div>
