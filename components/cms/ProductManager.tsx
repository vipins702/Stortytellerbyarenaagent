...
type Product = { id: string; websiteId: string; name: string; price: number; stock: number; status: "Active" | "Draft" | "Archived"; sku?: string | null; description?: string | null };
